...
sss-token fees show --mint <address>

# Update fee parameters
sss-token fees update --mint <address> --bps <number> --max-fee <number>

# Withdraw collected fees
sss-token fees withdraw --mint <address> --destination <token_account>
```
